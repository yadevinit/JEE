...
till.imetaYPq <- 6 # till specific index into metaYPq.
# imetaYPq <- till.imetaYPq + 1
...
metaYPq <- list( # Beware q here includes question-related media eg was including Paragraphs for (following) Questions.
  ...
  ,Y2014P2=list(P=c(1:20), C=c(21:40), M=c(41:60), iMerged=setdiff(316:376, c(316))) # TBD?? Beware: mcv index here.
)
  ...
  colnames(mmsqoss.tmp2read) <- "QOS2020Feb19.1025"
